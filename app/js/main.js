...
var _shareTemplate = require('./shareTemplate');

var _shareTemplate2 = _interopRequireDefault(_shareTemplate);

var _share_collection = require('./share_collection');

var _share_collection2 = _interopRequireDefault(_share_collection);

var _share_model = require('./share_model');

var _share_model2 = _interopRequireDefault(_share_model);

//PULL KEY INFO FROM THE API  IN PARSE
var APP_ID = 'pqv7DniTxgOhOxJg9COjkQUvFvDY9U3DV60MvnEn';
var API_KEY = '4uvFUxWqRxE6VfkytVjdTI8YihM7haqQmkW5SfWx';
...
var shareHolders = new _share_collection2['default']();
var holder = new _share_model2['default']();
...
var ShareCollection = _backbone2['default'].Collection.extend({
	url: 'https://api.parse.com/1/classes/Shares',
	model: _share_model2['default'],
...
},{"./share_model":4,"backbone":5}],4:[function(require,module,exports){
'use strict';
...
var ShareHolderModel = _backbone2['default'].Model.extend({
...
exports['default'] = ShareHolderModel;
